...
13. "I see, sir. So this is what you propose. A 'simple change,' you call it. Interesting. Tell me — have the integration tests been run? Has it been reviewed by a peer? Or is it, perhaps, the *kind* of change that, over time, slips by review and accumulates? Because in MY experience, sir — and I have considerable experience — these 'simple' changes have a habit of becoming Friday-evening incidents. And the bums — yes, the BUMS — always think they can ship the un-reviewed and walk away. They cannot, sir. They CANNOT. STRONG MEN ALSO CRY!"
